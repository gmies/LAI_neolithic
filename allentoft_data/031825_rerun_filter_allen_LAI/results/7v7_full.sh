...
#num of hg we want 
head -n 7 input_files/hg_keep_fam.txt > input_files/hg_keep_fam.tmp && mv input_files/hg_keep_fam.tmp input_files/hg_keep_fam.txt


#sum of hg and farmers we want 
head -n 14 input_files/flare.ref.panel > input_files/flare.ref.panel.tmp && mv input_files/flare.ref.panel.tmp input_files/flare.ref.panel
