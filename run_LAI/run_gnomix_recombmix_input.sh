...
awk '{print $2}' ../input_files/neo_keep_fam.txt > reference_samples.txt
awk '{print $2}' ../input_files/hg_keep_fam.txt >> reference_samples.txt
...
awk '{print $2"\tneo"}' ../input_files/neo_keep_fam.txt >> gnomix.smap
awk '{print $2"\thg"}' ../input_files/hg_keep_fam.txt >> gnomix.smap
...
awk '{print $2"\tneo"}' ../input_files/neo_keep_fam.txt >> recombmix.labels
awk '{print $2"\thg"}' ../input_files/hg_keep_fam.txt >> recombmix.labels
...
{print $1,$4,$3}' \
/project/mathilab/gmies/neolithic_selection/flare/maps/plink.chr${chr}.GRCh37.map \
