...
#plot hg tracts together from each method 
Rscript /project/mathilab/gmies/neolithic_selection/allentoft_data/031825_rerun_filter_allen_LAI/selection_analysis/same_format_042125/tract_lengths/plots/tract_lengths_ancestry.R 5 hg ../ancestry_hmm_haplotypes/phased_tracts_tract_lengths_data.txt ../ancestry_paths/phased_tracts_tract_lengths_data.txt ../mosaic/phased_tracts_tract_lengths_data.txt ../simplai/phased_tracts_tract_lengths_data.txt ../rfmix/phased_tracts_tract_lengths_data.txt ancestry_hmm_haplotypes ancestry_paths mosaic simplai rfmix

#plot farmer tracts together from each method
Rscript /project/mathilab/gmies/neolithic_selection/allentoft_data/031825_rerun_filter_allen_LAI/selection_analysis/same_format_042125/tract_lengths/plots/tract_lengths_ancestry.R 5 farmer ../ancestry_hmm_haplotypes/phased_tracts_tract_lengths_data.txt  ../ancestry_paths/phased_tracts_tract_lengths_data.txt ../mosaic/phased_tracts_tract_lengths_data.txt ../simplai/phased_tracts_tract_lengths_data.txt ../rfmix/phased_tracts_tract_lengths_data.txt ancestry_hmm_haplotypes ancestry_paths mosaic simplai rfmix
