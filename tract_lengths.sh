...
Rscript /project/mathilab/gmies/neolithic_selection/allentoft_data/031825_rerun_filter_allen_LAI/selection_analysis/same_format_042125/tract_lengths/theoretical/add_theoretical_tracts_5.R 4 hg ../ancestry_hmm/ancestry_hmm_tract_lengths_data.txt ../simplai/simplai_tract_lengths_data.txt ../rfmix/rfmix_tract_lengths_data.txt ../mosaic/mosaic_tract_lengths_data.txt ancestry_hmm simplai rfmix mosaic 

#plot farmer tracts together from each method
Rscript /project/mathilab/gmies/neolithic_selection/allentoft_data/031825_rerun_filter_allen_LAI/selection_analysis/same_format_042125/tract_lengths/theoretical/add_theoretical_tracts_5.R 4 farmer ../ancestry_hmm/ancestry_hmm_tract_lengths_data.txt ../simplai/simplai_tract_lengths_data.txt ../rfmix/rfmix_tract_lengths_data.txt ../mosaic/mosaic_tract_lengths_data.txt ancestry_hmm simplai rfmix mosaic 
